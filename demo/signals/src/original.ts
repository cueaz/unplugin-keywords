...
function addDependency(signal: Signal): Node | undefined {
  ...
  if (node === undefined || node._target !== evalContext) {
    ...
    if (node._nextSource !== undefined) {
      ...
      if (evalContext._sources) evalContext._sources._nextSource = node;
      evalContext._sources = node;
    }
...
interface Signal<T = unknown> {
  ...
  /** @internal */
  _watched?: ((this: Signal<T>) => void) | undefined;

  /** @internal */
  _unwatched?: ((this: Signal<T>) => void) | undefined;
 ...
 */
interface Effect {
  _fn?: EffectFn | undefined;
  _cleanup?: (() => void) | undefined;
  _sources?: Node | undefined;
  _nextBatchedEffect?: Effect | undefined;
  _flags: number;
  _debugCallback?: (() => void) | undefined;
  name?: string | undefined;
...
const wrapInAction = (value: Record<string | symbol, unknown>) => {
  ...
  for (let i = 0; i < keys.length; i++) {
    ...
    if (typeof val === 'function') {
      ...
      typeof val === 'object' &&
      val !== null &&
      !('brand' in (val as Record<PropertyKey, unknown>))
    ) {
